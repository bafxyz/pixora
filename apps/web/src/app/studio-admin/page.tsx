...
export default function AdminPage() {
  ...
  const [_selectedOrderForDelivery, setSelectedOrderForDelivery] =
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      // Загружаем гостей
      const guestsResponse = await fetch('/api/studio-admin/guests')
      ...
      // Загружаем заказы
      const ordersResponse = await fetch('/api/studio-admin/orders')
          ...
          <TabsContent value="qr" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  <Trans>Generate and manage QR codes for photo sessions</Trans>
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  <Trans>
                    QR code generation functionality will be available here.
                  </Trans>
                </p>
              </CardContent>
            </Card>
